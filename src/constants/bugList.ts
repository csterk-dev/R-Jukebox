...
export const bugList = [
  ...
  "WHen scrubbing video playback, there is a slight discrepancy between set value and the optimistic value. This only really becomes noticable on longer videos."
]